...
ac15-1:	$(FILES)
	$(CC) -o ac15-1 $(LFLAGS) @ac15-1.lk   -lcatmega
ac15-1.o: C:/icc/include/iom16v.h C:/icc/include/macros.h
ac15-1.o:	d:\MYDOCU~1\ac15-1\ac15-1.c
	$(CC) -c $(CFLAGS) d:\MYDOCU~1\ac15-1\ac15-1.c
